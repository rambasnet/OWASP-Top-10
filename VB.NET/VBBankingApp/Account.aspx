...
<body>
    ...
    <div style="height: 938px; margin-left: 40px">
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
            ID="btnSave" runat="server" onclick="btnSave_Click" Text="Save" Width="51px" />
        &nbsp; &nbsp;
        <br />
        <br />
        Accounts:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" 
            ...
            <AlternatingItemTemplate>
                <tr style="background-color:#FFF8DC;">
                    ...
                    <td>
                        <asp:Label ID="AccountNumLabel0" runat="server" 
                            Text='<%# Eval("AccountNum") %>' />
                    </td>
                    <td>
                        <asp:Label ID="ActivityLabel0" runat="server" Text='<%# Eval("Activity") %>' />
                    </td>
                    <td>
                        <asp:Label ID="AmountLabel0" runat="server" Text='<%# Eval("Amount") %>' />
                    </td>
                    <td>
                        <asp:Label ID="TimestampLabel0" runat="server" 
                            Text='<%# Eval("Timestamp") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            ...
            <EditItemTemplate>
                <tr style="background-color:#008A8C;color: #FFFFFF;">
                    ...
                    <td>
                        <asp:TextBox ID="AccountNumTextBox0" runat="server" 
                            Text='<%# Bind("AccountNum") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="ActivityTextBox0" runat="server" 
                            Text='<%# Bind("Activity") %>' />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="TimestampTextBox0" runat="server" 
                            Text='<%# Bind("Timestamp") %>' />
                    </td>
                </tr>
            </EditItemTemplate>
            <SelectedItemTemplate>
                <tr style="background-color:#008A8C;font-weight: bold;color: #FFFFFF;">
                    ...
                    <td>
                        <asp:Label ID="AccountNumLabel1" runat="server" 
                            Text='<%# Eval("AccountNum") %>' />
                    </td>
                    <td>
                        <asp:Label ID="ActivityLabel1" runat="server" Text='<%# Eval("Activity") %>' />
                    </td>
                    <td>
                        <asp:Label ID="AmountLabel1" runat="server" Text='<%# Eval("Amount") %>' />
                    </td>
                    <td>
                        <asp:Label ID="TimestampLabel1" runat="server" 
                            Text='<%# Eval("Timestamp") %>' />
                    </td>
                </tr>
            </SelectedItemTemplate>
