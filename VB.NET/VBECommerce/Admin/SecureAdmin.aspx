<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SecureAdmin.aspx.vb" Inherits="Admin_SecureAdmin" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnEdit" runat="server" Height="25px" onclick="btnEdit_Click" 
            style="margin-right: 3px" Text="Edit" Width="68px" />
        &nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnNew" runat="server" Height="26px" onclick="btnNew_Click1" 
            Text="Add New" Width="68px" />
        &nbsp;&nbsp;&nbsp;
        ...
        <input id="Token" name="Token" type="hidden" 
            value='<%Response.Write(Server.HtmlEncode(Session("Token").ToString()))%>' />
        <br />
        Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
