<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="Admin_Admin" ValidateRequest="false"%>
...
<body style="font-family: Arial, Helvetica, sans-serif; font-size: small">
    ...
    <div>
        ...
        <br />
        Select Clients:
        <asp:DropDownList ID="ddlClients" runat="server" AutoPostBack="True" DataTextField="Username" 
            DataValueField="Username" 
             Height="23px" 
            Width="118px" onselectedindexchanged="ddlClients_SelectedIndexChanged">
        </asp:DropDownList>
        <br />
        <br />
        <br />
...
&nbsp;
        <asp:Button ID="btnTransfer" runat="server" Height="24px" 
           Text="Transfer Money" Width="119px" onclick="btnTransfer_Click" />
&nbsp;
        <asp:Button ID="btnNew" runat="server" Height="24px" Text="Add New" 
            Width="66px" onclick="btnNew_Click" />
        &nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        Accounts:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;         <asp:DropDownList ID="ddlAccounts" runat="server" 
